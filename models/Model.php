...
class Model
{
    ...
    public function __construct() {
        ...
        $pdoOptions = [
            \PDO::ATTR_DEFAULT_FETCH_MODE => \PDO::FETCH_OBJ, // on rajoute "\" devant les class PDO a cause du namespace.
            \PDO::ATTR_ERRMODE => \PDO::ERRMODE_EXCEPTION
        ]; // les :: c'est pour les propriétés d'une class. Dans une class in y a des fonctions et des propriétés. $mon\PDO->$toto (pour les propriétés) pour les variable statique (qu'on ne peut utiliser que directement dnas la class) on utilise \PDO::$titi
